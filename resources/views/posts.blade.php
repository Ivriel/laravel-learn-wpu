...
@section('container')
  ...
  @if ($posts->count())
    <div class="card mb-3">
      <img src="https://picsum.photos/1200/800" class="card-img-top" alt="Image">
      <div class="card-body text-center">
        <h3 class="card-title"><a href="/posts/{{ $posts[0]->slug }}"
            class="text-decoration-none text-dark">{{ $posts[0]->title }}</a></h3>
        <p>
          <small class="text-body-secondary"> By. <a href="/authors/{{ $posts[0]->author->username }}"
    ...
    <div class="row">
      @foreach ($posts->skip(1) as  $post)
        ...
        <div class="card">
          ...
          <img src="https://picsum.photos/1200/800" class="card-img-top h-100" alt="Image">
          <div class="card-body">
            <h5 class="card-title"> {{ $post->title }}</h5>
            <p>
              <small class="text-body-secondary"> By. <a href="/authors/{{ $post->author->username }}"
