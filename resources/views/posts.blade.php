...
@section('container')
  ...
  @if ($posts->count())
    <div class="card mb-3">
      ...
      @else
        <img src="https://picsum.photos/1200/800" alt="{{ $posts[0]->category->name }}" class="img-fluid">
      @endif
        ...
        @foreach ($posts->skip(1) as $post)
          <div class="col-md-4 mb-3">
            <div class="card">
              ...
              @else
                <img src="https://picsum.photos/1200/800" alt="{{ $post->category->name }}" class="img-fluid">
              @endif
              <div class="card-body">
