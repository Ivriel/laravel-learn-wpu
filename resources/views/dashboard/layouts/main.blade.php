...
<head>
    ...
    <title>Ivriel Blog | Dashboard </title>
...
<body>
    <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
        ...
        <symbol id="pencil" viewBox="0 0 16 16">
            <path d="M12.854.146a.5.5 0 0 0-.707 0L11.07 1.293 14.707 4.93l1.147-1.147a.5.5 0 0 0 0-.707l-3.1-3.1zM11.5 2.5L3.236 10.764 1.5 9.027 9.764 1.263l1.736 1.237z"/>
            <path fill-rule="evenodd" d="M0 13.5A1.5 1.5 0 0 0 1.5 15h13a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-13a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H1.5A1.5 1.5 0 0 0 0 1.5v12z"/>
        </symbol>
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="row" style="height: 100%;">
           @include('dashboard.layouts.sidebar')
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 bg">
                @yield('container')
            </main>
        </div>
    </div>
