            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="category_id">
                    @foreach ($categories as $category)
                        {{-- biar ga ngereset pas ada error validasi --}}
                ...
                <div class="my-3">
                    ...
                    @if ($post->image)
                       <img src="{{ asset('storage/' . $post->image) }}" alt="" class="img-preview img-fluid mb-2 col-sm-5 d-block">
                        @else
                           <img alt="" class="img-preview img-fluid mb-2 col-sm-5" style="display: none;">
                    @endif
